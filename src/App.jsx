...
function RootRouter() {
  ...
  // a sites-shaped shell. Every other crew_type (fiber_construction /
  // field_service / install / contractor) stays on the existing CrewApp.
  //
  ...
  // requires their crew_type to be one of {fiber_construction, field_service,
